...
class CatalogAccessoryViewModel : ViewModel() {
    ...
    init {
        getAccessoryCatalogProduct()
    }

    fun getAccessoryCatalogProduct() {
        coroutineScope.launch {
            var getPropertiesDeferred =
                RetrofitApi.retrofitService.getCatagoryItem("accessories", paging)
            try {
