...
class CatalogWomenViewModel : ViewModel() {
    ...
    init {
        getWomenCatalogProduct()
    }

    fun getWomenCatalogProduct() {
        coroutineScope.launch {
            var getPropertiesDeferred = RetrofitApi.retrofitService.getCatagoryItem("women", paging)
            try {
